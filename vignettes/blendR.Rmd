...
The estimators included so far in this package are taken from @liu_estimation_2017 and are now described.
...
Each of the three estimators returns the values `total` and `se`, which are the estimates of total of the variable of interest and its standard error, respectively.
##References
